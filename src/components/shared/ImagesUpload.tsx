...
interface ImagesUploadProps {
  value: (FileWithPreview | MediaContent)[]; // Danh sách file hiện tại
  onChange: (files: (FileWithPreview | MediaContent)[]) => void; // Callback để truyền danh sách file lên component cha
}
...
const ImagesUpload = ({ value, onChange }: ImagesUploadProps) => {
  ...
  const removeFile = (file: FileWithPreview | MediaContent) => {
